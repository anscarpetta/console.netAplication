            ...
            while (a >= 1)
            {
                ...
                switch (program)
                {
                    ...
                    case 1:
                        ...
                        switch (forma.ToLower())
                        {
                            ...
                            case "circulo":
                                ...
                                break;
                            default:
                                Console.WriteLine("Nome de Forma Invalido!");
                                break;
                    ...
                    case 2:
                        ...
                        break;
                    default:
                        Console.WriteLine("Numero de Programa Invalido!");
                            break;
                }
                Console.WriteLine("\nDeseja executar novamente?");
                repeatDecision = Convert.ToString(Console.ReadLine());
                teste = repeatDecision.ToLower();
                if (teste == "sim")
                {
                    Console.WriteLine("---------------------------------------\n");
                    a = 1;
